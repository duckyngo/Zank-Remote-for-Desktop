...
class TutorialMainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.appPixmap_2 = QPixmap(utils.resource_path('tut1.png'))
        ...
        self.appPixmap_3 = QPixmap(utils.resource_path('tut1.png'))
...
class WebViewMainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.app_icon = QIcon(utils.resource_path("app_icon_round.png"))
...
class ControlPanelTabWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.appPixmap = QPixmap(utils.resource_path('app_icon_rgb.jpg'))
...
class ZankRemoteApplication(QApplication):
    ...
    def __init__(self, args):
        ...
        self.icon = QIcon(utils.resource_path("app_icon_round.png"))
