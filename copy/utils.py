...
def generate_qr_code(qr_content):
    ...
    logo_link = resource_path("app_icon_rgb.jpg")
...
def get_image_path_from_volume(target_volume):
    ...
    if 0 < target_volume <= 10:
        return resource_path("volume_level1.png")
    elif 10 < target_volume <= 20:
        return resource_path("volume_level2.png")
    elif 20 < target_volume <= 30:
        return resource_path("volume_level3.png")
    elif 30 < target_volume <= 40:
        return resource_path("volume_level4.png")
    elif 40 < target_volume <= 50:
        return resource_path("volume_level5.png")
    elif 50 < target_volume <= 60:
        return resource_path("volume_level6.png")
    elif 60 < target_volume <= 70:
        return resource_path("volume_level7.png")
    elif 70 < target_volume <= 80:
        return resource_path("volume_level8.png")
    elif 80 < target_volume <= 90:
        return resource_path("volume_level9.png")
    elif 90 < target_volume <= 100:
        return resource_path("volume_level10.png")
    elif 100 < target_volume <= 110:
        return resource_path("volume_level11.png")
    elif 110 < target_volume <= 120:
        return resource_path("volume_level12.png")
    elif 120 < target_volume <= 130:
        return resource_path("volume_level13.png")
    elif 130 < target_volume <= 140:
        return resource_path("volume_level14.png")
    elif 140 < target_volume <= 150:
        return resource_path("volume_level15.png")
    elif target_volume > 150:
        return resource_path("volume_level16.png")
